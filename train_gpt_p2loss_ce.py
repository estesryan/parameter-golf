...
class Hyperparameters:
    ...
    muon_weight_decay = float(os.environ.get("MUON_WEIGHT_DECAY", 0.012))
    adam_weight_decay = float(os.environ.get("ADAM_WEIGHT_DECAY", 0.012))
...
INT8_KEEP_FLOAT_MAX_NUMEL = int(os.environ.get("INT8_KEEP_FLOAT_MAX_NUMEL", 8192))
